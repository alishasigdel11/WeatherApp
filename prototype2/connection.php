...
if (mysqli_num_rows($result) == 0) {
    ...
    // If the data is older than 2 hours (7200 seconds)
...
if ($fetchNewData) {
    ...
    if ($data['cod'] == 200) {
        ...
        $insertData = "INSERT INTO weather_data (city, temperature, humidity, pressure, wind_speed, wind_dir, visibility, descriptions, mainweather, icon)
        VALUES ('$city','$temp','$humidity','$pressure','$windSpeed','$windDir','$visibility','$weatherDescription','$mainweather','$icon')
        ON DUPLICATE KEY UPDATE 
        temperature='$temp', humidity='$humidity', pressure='$pressure', wind_speed='$windSpeed', wind_dir='$windDir',
